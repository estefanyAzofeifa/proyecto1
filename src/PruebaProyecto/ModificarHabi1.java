 ...
 * @author estef
 */
public class ModificarHabi1 extends javax.swing.JFrame {

    /**
     * Creates new form ModificarHabi1
     */
    public ModificarHabi1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        atrashabi.setBackground(new java.awt.Color(153, 153, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarHabi1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarHabi1().setVisible(true);
            }
        });
    }
